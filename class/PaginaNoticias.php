...
class PaginaNoticias extends Pagina{
    ...
    public function __construct($logico, $pesquisa, $escolha, $coment){
        ...
        $this->PesquisarComentario("noticia", null);// Ele entrega o getComentario definido na mãe "Pagina.php" ("qual pagina do comentario", "data especifica do comentario")
