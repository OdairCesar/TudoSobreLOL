...
class PaginaTier extends Pagina{
	private objConteudo, objMenu, objDetalhes, objFooter, objPesquisa;
	private fazerDetalhes;

	public function MontarDetalhes(){
		if ($this->fazerDetalhes){
			$this->objDetalhes->MontarDiv($this->titulo, $this->subtitulo, $this->imagem, "P", $this->);
		}	
	}
	...
	public function __construct($logico, $pesquisa, $escolha){
		...
		$this->PassarValores($escolha, "Tier");
	}
