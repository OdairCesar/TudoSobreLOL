<html>
    ...
    <body>
        <?php
        require '../../class/MenuPagina.php';
        $menu = new MenuPagina();
        $menu->PassarLinks("../", "../noticia/", "../zoeras/", "../atualizacao/", "../tier/", "index.php");
        ...
        <form action="" method="POST">
            <fieldset id='Pessoa'><legend>Dados Pessoais</legend>
                ...
                <fieldset id='Sex'><legend>Sexo</legend>
                    ...
                    <label class='Imasc' for='Imasc'>Masculino</label>

                    <input id='Ifem' type='radio' name='sexo' value='Feminimo'>
                    <label class='Imasc' for='Ifem'>Feminimo</label>
                </fieldset>
